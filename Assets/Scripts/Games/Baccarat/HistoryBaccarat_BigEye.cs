...
public class HistoryBaccarat_BigEye : MonoBehaviour
{
    ...
    private void setPositionItemBigEye(int state)
    {
        ...
        if (state != 3)
        {
            sprItemHis.sprite = getSprBigRoad((TypeWinBaccarat)state, "BreadRoad");
        }
        ...
        if (HISTORY_LAST_BIGEYE_COL >= 64 * indexBigEye)
        {
            ...
            {
                var bkgTable = new GameObject("BkgTable", typeof(RectTransform));
    ...
    private Sprite getSprBigRoad(TypeWinBaccarat typeWin, string table)
    {
        Sprite spr;
        ...
        switch (typeWin)
        {
            case TypeWinBaccarat.Player:
                sprName = "_P";
                break;
            case TypeWinBaccarat.PlayerP:
                sprName = "_P_P";
                break;
            case TypeWinBaccarat.PlayerB:
                sprName = "_P_B";
                break;
            case TypeWinBaccarat.PlayerPb:
                sprName = "_P_PB";
                break;
            case TypeWinBaccarat.Banker:
                sprName = "_B";
                break;
            case TypeWinBaccarat.BankerP:
                sprName = "_B_P";
                break;
            case TypeWinBaccarat.BankerB:
                sprName = "_B_B";
                break;
            case TypeWinBaccarat.BankerPb:
                sprName = "_B_PB";
                break;
            case TypeWinBaccarat.Tie:
            case TypeWinBaccarat.TieP:
            case TypeWinBaccarat.TieB:
            case TypeWinBaccarat.TiePb:
                sprName = "_T";
                break;
        }
    ...
    public void getPositionToInsertSprite(int result, TypeWinBaccarat typeWin)
    {
    ...
    public void updateHistoryBigEye(TypeWinBaccarat typeWin)
    {
        GameObject itemHis = new GameObject();
        Image sprItemHis = itemHis.AddComponent<Image>();

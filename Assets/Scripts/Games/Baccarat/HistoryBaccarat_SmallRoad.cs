...
public class HistoryBaccarat_SmallRoad : MonoBehaviour
{
    ...
    private void setPositionItemSmallRoad(int state)
    {
        ...
        if (state != 3)
        {
            sprItemHis.sprite = getSprBigRoad((TypeWinBaccarat)state, "SmallRoad");
        }
    ...
    protected Sprite getSprBigRoad(TypeWinBaccarat typeWin, string table)
    {
        Sprite spr;
    ...
    public void updateHistorySmallRoad(TypeWinBaccarat typeWin)
    {
        GameObject itemHis = new GameObject();
        Image sprItemHis = itemHis.AddComponent<Image>();
    ...
    protected virtual void getPositionToInsertSprite(int result, TypeWinBaccarat typeWin)
    {

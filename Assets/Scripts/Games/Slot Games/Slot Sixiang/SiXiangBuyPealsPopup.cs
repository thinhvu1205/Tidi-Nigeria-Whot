...
public class SiXiangBuyPealsPopup : BaseView
{
    ...
    public void setInfo(int indexGem, int pricePearl, int bet, long agPlayer)
    {
        ...
        lbInfo.text = "Pay " + Utility.FormatNumber(price) + " chips to receive this gem!";//Globals.Config.formatStr(Globals.Config.getTextConfig("text_sixiang_buy_gem"), Globals.Config.FormatNumber(price));
    }

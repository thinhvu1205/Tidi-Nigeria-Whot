...
namespace Games.Slot_Games
{
    public class SymbolController : MonoBehaviour
    {
        ...
        [SerializeField] public SkeletonGraphic spine;
        [SerializeField] public SkeletonGraphic bgWin;
        [SerializeField] public Image sprite;
        [SerializeField] protected CollumController collumCtrl;

        [SerializeField] List<Sprite> spriteNormal = new List<Sprite>();
        [SerializeField] List<Sprite> spriteBlur = new List<Sprite>();
        ...
        public void spin()
        {
            ...
            indexSymbol++;
            transform.DOLocalMoveY(posNew, 0.25f).SetEase(Ease.InBack).OnComplete(() => { loopMove(); });
        }
        ...
        public void loopMove()
        {
            ...
            DOTween.Sequence().Append(transform.DOBlendableLocalMoveBy(new Vector2(0, -collumCtrl.stepMove), Speed))
                .AppendCallback(() =>
                {
        ...
        private void stopMove()
        {
            if (indexSymbol > 3)
            {
                ...
                else
                {
                    ...
                    transform.localPosition = new Vector2(transform.localPosition.x,
                        collumCtrl.positionReset + collumCtrl.stepMove);
                    ...
                    DOTween.Sequence().Append(transform
                        .DOBlendableLocalMoveBy(new Vector2(0, -collumCtrl.stepMove), Speed).SetEase(Ease.OutBack));
            ...
            else
            {
                ...
                DOTween.Sequence()
                    .Append(transform.DOBlendableLocalMoveBy(new Vector2(0, -collumCtrl.stepMove), speedMove)
        ...
        public void setSpine(int idSpine, float timeScale = 1.0f)
        {
            ...
            Utility.PlayAnimationByPath(spine, getSpinePath(idSpine), "animation", false);
        }
        ...
        {
            string path = "SiXiang/Spine/Icon/%s/skeleton_SkeletonData";
            List<string> listFolderName = new List<string>
                { "10", "J", "Q", "K", "A", "Dragon", "Tiger", "Turtle", "Phoenix", "Wild", "Scatter" };
            path = Utility.FormatString(path, listFolderName[idSpine]);
            return path;
        }
